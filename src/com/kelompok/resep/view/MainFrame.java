...
public class MainFrame extends JFrame {
    ...
    private JPanel buatFormPanel() {
        ...
        // PENTING: Set alignment ke atas agar label sejajar dengan bagian atas kotak teks
        ...
        btnSimpan.addActionListener(e -> {
            ...
            try {
                ...
                manager.tambahResep(r); // Simpan ke File & List
    ...
    private void refreshTable() {
        ...
        for(Recipe r : manager.getAllResep()) {
            ...
            if(strLangkah.isEmpty()) strLangkah = "Tidak ada langkah";
